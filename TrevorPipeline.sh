...
./MarginPhase/marginPhase/build/marginPolish  ./Medaka/medaka_walkthrough_trevor/consensus/calls_to_draft.bam \
  ./Medaka/medaka_walkthrough_trevor/${DRAFT} \
  ./MarginPhase/marginPhase/params/allParams.np.json \
  -o ${MARGINPHASEFASTA}

# move files that will mess with creating the results 
mkdir ./Medaka/medaka_walkthrough_trevor/consensusMedakaBasic
mv ./Medaka/medaka_walkthrough_trevor/consensus ./Medaka/medaka_walkthrough_trevor/consensusMedakaBasic
